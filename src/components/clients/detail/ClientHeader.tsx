        ...
        <div className="flex flex-col items-center md:flex-row md:items-center gap-4 md:gap-6 text-center md:text-left">
          ...
          <div className="flex flex-col space-y-1 md:space-y-2">
            <div className="flex items-center justify-center md:justify-start gap-2">
              ...
              <div
                className={cn(
                  "hidden md:flex px-2 py-0.5 rounded-md border text-[10px] items-center gap-1 shadow-sm font-black uppercase tracking-widest",
                  badge.className,
                )}
              >
            ...
            <div
              className={cn(
                "flex md:hidden px-2 py-0.5 mt-2 rounded-md border text-[10px] items-center justify-center w-fit mx-auto gap-1 shadow-sm font-black uppercase tracking-widest",
                badge.className,
              )}
            >
              <StatusIcon className="h-3.5 w-3.5" />
              ...
              {client.nextInstallmentDate ? (
                <>
                  ...
                  <div className="mt-4 flex items-center gap-1.5 text-[10px] font-bold text-zinc-500 uppercase tracking-widest">
                    Vencimiento:{" "}
                    {new Date(client.nextInstallmentDate).toLocaleDateString(
                      "es-DO",
            ...
            <CardContent className="p-0 h-full flex flex-col">
              <div className="p-6 flex-1 flex flex-col justify-center">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-[10px] font-black text-white/50 dark:text-background/50 uppercase tracking-widest">
                    Quick Actions
                  </p>
                  <Button
                    size="icon"
                    variant="ghost"
                    className="h-6 w-6 rounded-full bg-white/10 hover:bg-emerald-500 hover:text-white dark:bg-background/10 dark:hover:bg-background/30 text-white dark:text-background border-none"
                    asChild
                  >
                    <a
                      href={whatsappLink}
                ...
                <div className="flex flex-col gap-2 mt-2">
                  <Button
                    className="justify-between bg-white/10 hover:bg-white/20 text-white dark:bg-background/10 dark:hover:bg-background/20 dark:text-background border-none group/btn shadow-none h-10"
                    asChild
                  >
                    <Link href={`/loans/new?client_id=${client.id}`}>
                  ...
                  <CreatePaymentDialog
                    ...
                    trigger={
                      <Button className="justify-between bg-white text-slate-900 hover:bg-zinc-100 dark:bg-background dark:text-primary dark:hover:bg-zinc-50 border-none group/btn shadow-none h-10 w-full text-left">
                        <div className="flex items-center gap-2 font-bold uppercase tracking-widest text-[10px]">
