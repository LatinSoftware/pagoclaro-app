    ...
    <div className="min-h-screen bg-slate-950 font-(family-name:--font-inter) text-slate-100 overflow-x-hidden selection:bg-teal-500/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            >
              ...
              <span className="font-(family-name:--font-outfit) font-bold text-2xl tracking-tight text-white">
                PagoClaro
              </span>
            </motion.div>
            <nav className="hidden md:flex gap-8">
              <Link
                href="#features"
                className="text-slate-300 hover:text-teal-300 transition-colors font-medium"
              >
                Core Engine
              </Link>
              <Link
            ...
            >
              <Link
                href="/login"
                className="hidden sm:flex px-5 py-2.5 text-teal-300 font-semibold hover:bg-teal-950/50 rounded-xl transition-colors items-center"
              >
                Iniciar Sesión
              </Link>
      ...
      <section className="relative pt-24 pb-16 md:pt-36 md:pb-32 px-4 z-10">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24 relative">
          ...
          >
            <motion.div
              variants={fadeInUp}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-950/50 border border-teal-500/20 text-teal-300 text-sm font-medium mb-8 backdrop-blur-md"
            >
              <Sparkles className="w-4 h-4" /> La plataforma premium para
              prestamistas
            </motion.div>
            <motion.h1
              variants={fadeInUp}
              className="font-(family-name:--font-outfit) text-5xl md:text-7xl font-bold tracking-tight leading-[1.1] mb-8 text-white"
            >
              Sistemas de control que{" "}
              <span className="text-transparent bg-clip-text bg-linear-to-r from-teal-400 via-emerald-400 to-teal-400 bg-[length:200%_auto] animate-pulse">
                inspiran confianza.
              </span>
            </motion.h1>
            <motion.p
            ...
            >
              Abandona el desorden. PagoClaro proporciona la infraestructura
              visual y operativa definitiva para gestionar préstamos,
              proyecciones de cobro y mora con una claridad absoluta.
            </motion.p>
            <motion.div
              variants={fadeInUp}
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            {[
              ...
              >
                <span className="text-3xl font-bold font-(family-name:--font-outfit) text-transparent bg-clip-text bg-linear-to-r from-teal-400 to-emerald-400">
                  {stat.value}
                </span>
                <span className="text-sm font-medium text-slate-500 mt-2 tracking-wide uppercase">
                  {stat.label}
                </span>
              </motion.div>
            ))}
      ...
      <section id="features" className="relative z-10 py-32 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="font-(family-name:--font-outfit) text-4xl md:text-5xl font-bold tracking-tight text-white mb-6">
              Un ecosistema diseñado para la eficiencia operativa.
            </h2>
            <p className="text-xl text-slate-400 font-light">
              Hemos reemplazado la complejidad abrumadora por interfaces
              intuitivas, rápidas y repletas del aura tecnológica que tu negocio
              merece.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                desc: "Indexa a cada cliente con tarjetas flotantes y búsqueda en tiempo real.",
                glow: "from-blue-500/20",
              },
              {
                icon: Activity,
                title: "Algoritmo de Préstamos",
                desc: "Amortizaciones y calendarios generados automáticamente en milisegundos.",
                glow: "from-teal-500/20",
              },
              {
                icon: CreditCard,
                title: "Reconciliación de Pagos",
                desc: "Registra cobros y observa cómo los indicadores de progreso se llenan de vida.",
                glow: "from-emerald-500/20",
              },
              {
                icon: Clock,
                title: "Radar de Riesgo (Mora)",
                desc: "Módulos de alerta temprana que identifican cuotas retrasadas inmediatamente.",
                glow: "from-orange-500/20",
              },
              {
                icon: ShieldCheck,
                title: "Seguridad Activa",
                desc: "Datos encriptados y permisos por niveles para que tu capital siempre esté seguro.",
                glow: "from-purple-500/20",
              },
              {
                icon: PieChart,
                title: "Analytics Nivel SaaS",
                desc: "Dashboards de salud del negocio que rivalizan con sistemas financieros corporativos.",
              ...
              <motion.div
                ...
                className={`p-8 rounded-4xl bg-slate-900/40 border border-white/5 hover:border-teal-500/30 transition-colors group relative overflow-hidden backdrop-blur-xl`}
              >
                <div
                  className={`absolute -top-24 -right-24 w-48 h-48 bg-linear-to-br ${feature.glow} to-transparent rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700`}
                ></div>
                ...
                <h3 className="text-2xl font-bold text-slate-100 mb-3 font-(family-name:--font-outfit) relative z-10">
                  {feature.title}
                </h3>
      ...
      <section
        id="how-it-works"
        className="relative z-10 py-32 px-4 border-t border-white/5 bg-slate-950/80"
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <h2 className="font-(family-name:--font-outfit) text-4xl md:text-5xl font-bold tracking-tight mb-4 text-white">
              Domina el flujo operativo
            </h2>
            <p className="text-xl text-slate-500 font-light">
              Interfaces premium convertidas en una experiencia operativa
              perfecta.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              <motion.div
                ...
                className="relative z-10 rounded-2xl overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.6)] border border-teal-500/20"
              >
                <Image
                  src="/epic-clients.png"
                  alt="Clients Interface"
                  width={600}
                  height={400}
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-slate-900 border border-teal-500/30 flex items-center justify-center text-teal-400 text-3xl font-bold font-(family-name:--font-outfit) mb-8 shadow-[0_0_30px_rgba(20,184,166,0.2)]">
                1
              </div>
              <h3 className="text-3xl font-bold mb-4 font-(family-name:--font-outfit) text-white">
                Central de Clientes
              </h3>
              <p className="text-xl text-slate-400 font-light leading-relaxed">
                Olvídate de buscar datos. Cada cliente vive en una tarjeta
                inteligente interactiva que muestra su puntaje de riesgo,
                préstamos activos e historial en un segundo.
              </p>
            </motion.div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center mt-32">
            <motion.div
              ...
              variants={fadeInUp}
            >
              <div className="w-16 h-16 rounded-2xl bg-slate-900 border border-emerald-500/30 flex items-center justify-center text-emerald-400 text-3xl font-bold font-(family-name:--font-outfit) mb-8 shadow-[0_0_30px_rgba(16,185,129,0.2)]">
                2
              </div>
              <h3 className="text-3xl font-bold mb-4 font-(family-name:--font-outfit) text-white">
                Telemetría de Pagos
              ...
              <p className="text-xl text-slate-400 font-light leading-relaxed">
                Monitorea el estatus de las cuotas con marcadores visuales que
                actúan como indicadores vitales de tu negocio. Si una métrica
                cambia de arcoíris verde a naranja, es hora de actuar.
              </p>
            </motion.div>
            ...
            >
              <motion.div
                ...
                className="relative z-10 w-[60%] mx-auto rounded-3xl overflow-hidden shadow-[0_40px_80px_rgba(0,0,0,0.8)] border border-emerald-500/20 bg-slate-900"
              >
                <Image
      ...
      <section className="relative z-20 py-32 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-75 bg-linear-to-b from-teal-500/20 to-transparent blur-[80px]"></div>

            <div className="relative z-10">
              <ShieldCheck className="w-16 h-16 text-teal-400 mx-auto mb-8 drop-shadow-[0_0_15px_rgba(45,212,191,0.5)]" />
              <h2 className="font-(family-name:--font-outfit) text-4xl md:text-6xl font-bold mb-8 text-white tracking-tight">
                Eleva el status de tu operación.
              </h2>
              <p className="text-xl text-slate-300 font-light mb-12 max-w-2xl mx-auto">
                Deja atrás las libretas, los Excels y la fricción. Ingresa a la
                nueva era del control financiero directo y seguro.
              </p>
      ...
      <footer className="relative z-10 border-t border-white/5 bg-slate-950 py-16 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex items-center gap-3 opacity-60 hover:opacity-100 transition-opacity">
            ...
            <span className="font-(family-name:--font-outfit) font-bold text-xl text-white tracking-tight">
              PagoClaro
            </span>
          </div>
